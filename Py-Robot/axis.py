...
kit.continuous_servo[0].set_pulse_width_range(1000, 2100)
kit.continuous_servo[1].set_pulse_width_range(1000, 2100)
kit.continuous_servo[2].set_pulse_width_range(1000, 2100)
kit.continuous_servo[3].set_pulse_width_range(1000, 2100)
